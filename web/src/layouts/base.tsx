  ...
  return (
    <div className="flex flex-col h-full">
      <header className="pt-2 flex justify-end gap-2 mr-2 content-center">
        ...
        <Select onSelectionChange={(key)=> {changeLanguage(key)}} defaultSelectedKeys={[i18n.locale]} className='flex-initial w-36' size="sm" items={languages} label={<Trans>Languages</Trans>}>
