...
func IngestNote(ctx context.Context, p types.IngestNotePayload, opts ...contracts.Option) (string, error) {
	...
	return asynqSingleton.Dispatcher().Enqueue(ctx, types.IngestNoteKey, b, all...)
}
